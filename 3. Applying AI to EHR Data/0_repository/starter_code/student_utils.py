...
def reduce_dimension_ndc(df, ndc_df):
    ...
    return:
        df:  dataframe with joined generic drug name
    '''
    ...
    df = df.drop(['NDC_Code', 'Proprietary Name'], axis=1)
    return df
...
def select_first_encounter(df):
    ...
    first_encounter_df = first_encounter_df.drop_duplicates(subset=['patient_nbr'], keep='first')
